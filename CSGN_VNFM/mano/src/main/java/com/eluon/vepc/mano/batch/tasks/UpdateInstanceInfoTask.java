...
/**
 * UpdateInstanceInfoTask (UpdateInstanceInfoTask)
 *
 * @author <a href="mailto:simhero@mredriver.com">SimByungChul</a>
 * @version $Id: UpdateInstanceInfoTask.java,v1.0 2015/04/17 00:00:00 SimByungChul Express $
 */
public class UpdateInstanceInfoTask implements Tasklet {
	...
	public RepeatStatus execute(StepContribution stepContribution, ChunkContext chunkContext) throws Exception {
        ...
        try {
        	logger.debug("String Batch Quartz Test UpdateInstanceInfoTask");
            stepExecution.setExitStatus(exitStatus.addExitDescription("good job"));
        } catch (RuntimeException e) {
        	logger.error("Exception occurred during UpdateInstanceInfoTask.execute", e);
