...
gruntConnectProxy = require("grunt-connect-proxy/lib/utils").proxyRequest
...
module.exports = (grunt) ->
            ...
            livereload:
                options:
                    middleware: (connect) ->
                        ...
                        [gruntConnectProxy, lrSnippet, mountFolder(connect, yeomanConfig.tmp), mountFolder(connect, yeomanConfig.app)]
        ...
        uglify:
            ...
            dist:
                files:
                    ...
                    "<%= yeoman.dist %>/scripts/app.js": ["<%= yeoman.tmp %>/**/*.js", "<%= yeoman.app %>/scripts/**/*.js"]
    ...
    grunt.registerTask "lessServer", (target) ->
        ...
        grunt.task.run ["clean:server", "configureProxies:manoServer", "concurrent:lessServer", "connect:livereload", "open", "watch"]
